...
/** 신뢰 원칙 — 의뢰자가 경험하는 것 위주로, 담백하게 */
const PRINCIPLES: [string, string, string][] = [
  ["블라인드", "기관은 서로의 견적을 볼 수 없습니다", "회신은 의뢰자에게만 전달됩니다. 어느 기관도 다른 기관의 금액이나 조건을 알 수 없고, 의뢰자가 선택하기 전까지 연락처도 열리지 않습니다. 기한이 지나면 제출한 회신은 고칠 수 없습니다."],
  ["공정 경쟁", "모든 기관이 같은 요청서를 같은 기한으로 받습니다", "수행 가능한 기관 전부에 같은 내용이 자동으로 전달되고, 회신 기한도 같습니다. 단추는 기관을 추천하거나 순위를 매기지 않고, 최저가는 표시만 합니다. 선택은 의뢰자가 합니다."],
  ["기록", "진행 과정이 시각과 함께 남습니다", "접수, 배포, 회신 도착, 비교표 공개, 선택이 요청서마다 시각과 함께 기록되어 의뢰자 화면에 그대로 보입니다."],
  ["정본 우선", "비교표와 견적서가 다르면 견적서가 우선합니다", "비교표는 보기 쉽게 정리한 표이고, 효력은 기관이 첨부한 정식 견적서 PDF에 있습니다. 둘이 어긋나면 단추가 기관에 확인해 알려드립니다."],
  ["의뢰자 무료", "견적 요청과 비교표 수령에 비용이 없습니다", "의뢰자에게는 비용을 청구하지 않습니다. 계약은 의뢰자와 기관이 직접 체결하며, 단추는 조건에 개입하지 않습니다."],
];
      ...
      <main style={{ flex: 1 }}>
        <section className="sub">
          ...
          <h1 className="sub__title">
            모든 기관의 견적을
            <br />
            같은 양식으로, 비교하기 쉽게 전해드립니다.
          </h1>
          <p className="sub__lead">
            단추는 비임상 시험을 의뢰하는 연구자와 GLP 인증 시험기관을 연결하는 견적 플랫폼입니다. 의뢰자는 표준 양식으로 한 번만 요청하고, 수행 가능한 기관 전부가 같은 양식으로 회신하며, 단추는 그 회신을 비교하기 쉬운 표 한 장으로 전해드립니다.
          </p>
        </section>
